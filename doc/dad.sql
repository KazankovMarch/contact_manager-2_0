...
insert into dict_phonetype (id, code, name, fullname) values (1, 'hm', 'home', 'Home phone');
insert into dict_phonetype (id, code, name, fullname) values (2, 'mb', 'mobile', 'Mobile phone');
insert into dict_phonetype (id, code, name, fullname) values (3, 'wk', 'work', 'Work phone');
